...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  { position: 4, name: 'Gas discount -15%', count: 2, date: '05-09-2022' },
  { position: 5, name: 'De-Composter MUG', count: 2, date: '05-09-2022' },
  { position: 6, name: 'Eco-friendly Bag', count: 2, date: '05-09-2022' },
  { position: 7, name: 'Browar Lubicz Voucher', count: 2, date: '05-09-2022' },
];
@Component({
